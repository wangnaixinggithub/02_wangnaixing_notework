# Spring-Merge-JPA-Use-Anno-Query-Param
...
public interface UserRepository extends JpaRepository<User,Long> {
    ...
    List<User> findByNameOrAddress(@Param("name") String name, @Param("address") String address);
     ...
     */
    @Query("select u from User u where u.name = :name")
    List<User> findByNameIs(@Param("name") String name);
     ...
     */
    @Query("select u from User u where u.name = :name")
    List<User> findByNameEquals(@Param("name") String name);
     ...
     * @return
     */
    @Query("select u from User u where u.birth between :date1 and :date2")
    List<User> findByBirthBetween(@Param("date1") Date date1, @Param("date2") Date date2);
     ...
     * @return
     */
    @Query("select u from User u where u.birth < :date")
    List<User> findByBirthLessThan(@Param("date") Date date);
     ...
     */
    @Query("select u from User u where u.birth < :date")
    List<User> findByBirthBefore(@Param("date") Date date);
     ...
     */
    @Query("select u from User u where u.birth <= :date")
    List<User> findByBirthLessThanEqual(@Param("date") Date date);
     ...
     */
    @Query("select u from User u where u.birth > :date")
    List<User> findByBirthGreaterThan(@Param("date") Date date);
     ...
     */
    @Query("select u from User u where u.birth > :date")
    List<User> findByBirthAfter(@Param("date") Date date);
     ...
     */
    @Query("select u from User u where u.birth >= :date")
    List<User> findByBirthGreaterThanEqual(@Param("date") Date date);
     ...
     * @return
     */
    @Query("select u from User u where u.name = :name order by name desc ")
    List<User> findByNameOrderByNameDesc(@Param("name") String name);
     ...
     */
    @Query("select u from User u where u.name <> :name  ")
    List<User> findByNameNot(@Param("name") String name);
     ...
     */
    @Query("select u from User u where u.name = :name ")
    List<User> findByName(@Param("name") String name, Sort sort);
