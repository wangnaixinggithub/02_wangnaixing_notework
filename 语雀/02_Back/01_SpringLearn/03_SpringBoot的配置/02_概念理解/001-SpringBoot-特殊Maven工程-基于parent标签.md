> 父版本依赖。普通的Maven工程变为SpringBoot工程。
...
```xml
  <properties>
    ...
    <!--JDK版本为JDK1.8，工程编译，工程打包都用JDK1.8-->
...
- 针对application.yaml的通配符资源过滤，支持profile定义的application-dev,application-prod,application-test定义不同环境的配置文件。

```xml
 <build>
      <!--Maven打包工程，resource文件文件夹下application*.开头的yaml格式，yml格式，properties文件不过滤。-->  
      <!--
		通配过滤的好处：
...
![](001-SpringBoot-%E7%89%B9%E6%AE%8AMaven%E5%B7%A5%E7%A8%8B-%E5%9F%BA%E4%BA%8Eparent%E6%A0%87%E7%AD%BE.assets/image-20220326152056724.png)

- dependencyManagement依赖管理标签，规定了Web工程全部默认的依赖。统一版本管理。

![](001-SpringBoot-%E7%89%B9%E6%AE%8AMaven%E5%B7%A5%E7%A8%8B-%E5%9F%BA%E4%BA%8Eparent%E6%A0%87%E7%AD%BE.assets/image-20220326152216649.png)
